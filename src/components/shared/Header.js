...
class Header extends React.Component{
    ...
    renderAuthButtons(){
        ...
        if(isAuth){
            // return <a className='nav-item nav-link' onClick={this.props.logout} >Logout</a>
            return <a className='nav-item nav-link clickableAnchor' onClick={this.props.logout} >Logout</a>
